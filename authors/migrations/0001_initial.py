# Generated by Django 3.1.6 on 2021-12-05 21:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(blank=True, default=uuid.uuid4, max_length=1000, null=True, unique=True, verbose_name='url_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, default='followers', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author_id', models.CharField(blank=True, default=uuid.uuid4, max_length=1000, null=True, unique=True, verbose_name='author_id')),
                ('foreign_author_id', models.CharField(blank=True, default=uuid.uuid4, max_length=1000, null=True, unique=True, verbose_name='foreign_author_id')),
        ...
        migrations.CreateModel(
            name='Inbox',
            fields=[
                ('inbox_type', models.CharField(default='inbox', max_length=100)),
                ('inbox_author_id', models.CharField(default='', max_length=100, primary_key=True, serialize=False)),
                ('author', models.CharField(blank=True, default='', max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('context', models.URLField(default='', verbose_name='@context')),
        ...
        migrations.CreateModel(
            name='Post',
            fields=[
                ('post_id', models.UUIDField(auto_created=True, default=uuid.uuid4, primary_key=True, serialize=False, verbose_name='UUid')),
                ('type', models.CharField(default='post', editable=False, max_length=100, verbose_name='type')),
                ('title', models.CharField(default='', max_length=100)),
                ('id', models.CharField(blank=True, default='post', max_length=500, verbose_name='URL_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_type', models.CharField(default='comment', editable=False, max_length=100, verbose_name='type')),
                ('comment', models.TextField(default='')),
                ('contentType', models.CharField(choices=[('text/markdown', 'Markdown'), ('text/plain', 'Plain'), ('application/base64', 'Application'), ('image/png;base64', 'Image Png'), ('image/jpeg;base64', 'Image Jpeg')], default='text/plain', max_length=20)),
                ('published', models.DateTimeField(auto_now_add=True)),
                ('id', models.CharField(blank=True, default='post', max_length=500, verbose_name='URL_id')),
                ('comment_author', models.ForeignKey(default='', editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='authors', to=settings.AUTH_USER_MODEL)),
                ('comment_post', models.ForeignKey(default='', editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='commentsSrc', to='authors.post')),
            ],
        ),
    ]
