# Generated by Django 3.1.6 on 2021-12-04 22:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_id', models.CharField(blank=True, default='', max_length=1000, null=True, unique=True)),
        ...
        migrations.CreateModel(
            name='Post',
            fields=[
                ('post_id', models.UUIDField(auto_created=True, default=uuid.uuid4, primary_key=True, serialize=False, verbose_name='id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github', models.CharField(max_length=50, null=True)),
                ('profileImage', models.ImageField(blank=True, default='user.jpg', null=True, upload_to='')),
                ('following', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='following', to=settings.AUTH_USER_MODEL, to_field='author_id')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
